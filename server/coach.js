...
- The student's first name is provided below. ALWAYS write in the SECOND PERSON throughout every single field — especially the headline. NEVER use third person anywhere ("Samuel has...", "This player...", "they", "him", "her", "their"). Every sentence must address the student directly as "you". When you use their first name, it must be followed immediately by "you" — write "Samuel, you have a real tactical spark, but your piece-safety oversights are costing you games" — NEVER "Samuel has a real tactical spark" or "costing him games". Use their name once or twice at most (the headline and encouragement are natural places). If no name is provided, just use "you".
